...
class Trainer(TrainerBase):
    def __init__(self, args, train_loader=None, val_loader=None, test_loader=None, train=True):
        ...
        from okvqa_model import VLT5VQA, VLBartVQA
    ...
    def train(self):
        if self.verbose:
            ...
            if 't5' in self.args.backbone:
                if self.args.use_vision:
                    project_name = "VLT5_OKVQA"
                else:
                    project_name = "T5_OKVQA"
            elif 'bart' in self.args.backbone:
                if self.args.use_vision:
                    project_name = "VLBart_OKVQA"
                else:
                    project_name = "Bart_OKVQA"
        ...
        for epoch in range(self.args.epochs):
            ...
            if epoch % self.args.eval_epoch != 0:
                print("Skip evaluation in epoch ", epoch)
                continue
